    ...
    <div className="min-h-screen">
      ...
      <nav className="navbar fixed top-0 left-0 right-0 h-20 bg-white/90 backdrop-blur-md z-50 border-b border-black/5 transition-shadow duration-300">
        <div className="container-custom h-full flex justify-between items-center">
          <div className="flex items-center gap-3 font-display font-extrabold text-2xl text-primary-dark">
      ...
      {/* Hero Section */}
      <section className="pt-40 pb-20 min-h-[90vh] flex items-center overflow-hidden relative" style={{background: 'radial-gradient(circle at top right, rgba(16, 185, 129, 0.05) 0%, rgba(255,255,255,0) 50%)'}}>
      ...
      {/* Footer */}
      <footer className="bg-white pt-20 pb-6 border-t border-black/5">
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
            <div className="md:col-span-1">
              <div className="flex items-center gap-3 font-display font-extrabold text-2xl text-primary-dark mb-4">
            ...
            <div className="md:col-span-2 grid grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="flex flex-col gap-3">
                  <a href="#" className="text-slate-500 hover:text-accent">About</a>
                  <a href="#" className="text-slate-500 hover:text-accent">Careers</a>
                  <a href="#" className="text-slate-500 hover:text-accent">Contact</a>
                </div>
              </div>
              <div>
                <h4 className="text-lg mb-5 text-primary-dark">Legal</h4>
                <div className="flex flex-col gap-3">
                  <a href="#" className="text-slate-500 hover:text-accent">Privacy</a>
                  <a href="#" className="text-slate-500 hover:text-accent">Terms</a>
